...
console.log(process.env);
const MONGO_DATABASE = `mongodb+srv://${process.env.MONGO_DB_USER_NAME}:${process.env.MONGO_DB_PASSWORD}@tomvisions-serverless-i.wdrkx.mongodb.net/${process.env.MONGO_DB_NAME_STAGE}`
