...
export class MailController {
    static async apiPostSendMail(req: any, res: any, next: any) {
        ...
        let params = [mailMapper.PARAMS_BODY, mailMapper.PARAMS_EMAIL_TYPE, mailMapper.PARAMS_PHONE, mailMapper.PARAMS_NAME, mailMapper.PARAMS_SUBJECT, mailMapper.PARAMS_EMAIL];
        const missingParam = [];
        let valid = true;
        try {
